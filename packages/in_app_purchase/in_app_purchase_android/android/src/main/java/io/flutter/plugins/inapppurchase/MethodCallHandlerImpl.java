...
import static io.flutter.plugins.inapppurchase.Translator.*;
...
class MethodCallHandlerImpl
    ...
    // TODO(garyq): Migrate to new subscriptions API:
        ...
        for (final String productId : skusList) {
            productList.add(
                    QueryProductDetailsParams.Product.newBuilder()
                            ...
                            .setProductType(skuType.equals("inapp") ? BillingClient.ProductType.INAPP : BillingClient.ProductType.SUBS)
                            .build()
            );
        }
...
//        }
    ...
    private void consumeAsync(String purchaseToken, final MethodChannel.Result result) {
        ...
        ConsumeParams.Builder paramsBuilder = ConsumeParams.newBuilder().setPurchaseToken(purchaseToken);
    ...
    private void queryPurchasesAsync(String skuType, MethodChannel.Result result) {
        ...
        // Like in our connect call, consider the billing client responding a "success"
        // here regardless
        // of status code.
        ...
        billingClient.queryPurchasesAsync(
                ...
                new PurchasesResponseListener() {
                    ...
                    public void onQueryPurchasesResponse(
                        ...
                        // The response code is no longer passed, as part of billing 4.0, so we pass OK
                        // here
    ...
    private void launchPriceChangeConfirmationFlow(String sku, MethodChannel.Result result) {
        ...
        // Note that assert doesn't work on Android (see
        // https://stackoverflow.com/a/6176529/5167831 and
        // https://stackoverflow.com/a/8164195/5167831)
        // and that this assert is only added to silence the analyser. The actual null
        // check
        ...
        PriceChangeFlowParams params = new PriceChangeFlowParams.Builder().setSkuDetails(skuDetails).build();
